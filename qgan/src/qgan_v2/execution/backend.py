...
def load_or_create_real_backend_info(config, real_backend=None):
    ...
    try:
        ...
        print(f"Could not load cached backend info: {type(exc).__name__}: {exc}")
        print("Recreating backend info.")
...
def load_or_create_fake_real_backend_info(config, sherbrooke_backend=None):
    ...
    try:
        ...
        print(f"Could not load cached fake backend info: {type(exc).__name__}: {exc}")
        print("Recreating fake backend info.")
