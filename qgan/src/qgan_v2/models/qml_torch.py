...
from qgan_v2.execution.backend import create_backends
from qgan_v2.models.qnn import (
...
def generate_eval_g(encoding, gen_eval_model, model_g, eval_backend, config):
    if encoding == 'angle':
...
def generate_eval_model(encoding, ran_gen_circuit, obs_eval, eval_estimator, eval_backend, eval_pm):
    if encoding == 'angle':
...
def generate_models(config, circuit_bundle):
    ...
    gen_eval_model = generate_eval_model(encoding, ran_gen_circuit, obs_eval, eval_estimator, eval_backend, eval_pm)
    ...
    eval_g = generate_eval_g(encoding, gen_eval_model, model_g, eval_backend, config)
