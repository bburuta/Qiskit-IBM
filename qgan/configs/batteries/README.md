...
- `train/`: full training batteries used for learning dynamics and timing studies. Local simulator batteries are split by CPU/GPU device, and real-hardware studies live in separate `*_rh.yaml` files.
